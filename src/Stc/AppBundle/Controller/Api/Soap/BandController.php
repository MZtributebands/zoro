...
class BandController extends SoapController
{
    /**
     * @Soap\Method("getBands")
     * @Soap\Param("page", phpType="int")
     * @Soap\Param("limit", phpType="int")
     * @Soap\Param("order", phpType="string")
     * @Soap\Result(phpType="Stc\AppBundle\Entity\BandSoap[]")
    ...
    /**
     * @Soap\Method("createBand")
     * @Soap\Param("case", phpType="Stc\AppBundle\Entity\BandSoap")
